...
# Main Title
st.title(":rocket: AI for Accelerating Discovery of A₂BCX₄ and ABX₂ Semiconductors for Thin-Film Solar Cells")
...
# Background Section
st.markdown("""
### :sun_with_face: Background: Challenges in Thin-Film Solar Cells
...
:bulb: **AI-Powered Material Discovery**
...
""")
# Create Tabs
tab1, tab2 = st.tabs([":bar_chart: Composition-Based ML Model", ":chart_with_upwards_trend: Graph-Based MLFF Optimization"])
with tab1:
